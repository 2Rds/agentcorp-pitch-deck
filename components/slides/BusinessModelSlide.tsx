...
const margins = [
  ...
  { label: 'White-Glove', value: '67%', note: '+$1,500/mo on Scale', color: '#8b9cf7' },
];
    ...
    <div className="slide-shell">
      ...
      <motion.div className="slide-inner" variants={c} initial="hidden" animate="visible">
        ...
        <motion.p variants={i} style={{ fontFamily: 'var(--font-body)', fontSize: '0.8rem', color: 'var(--text-3)', maxWidth: 700 }}>
          $0.05/credit effective rate. Overage at $0.10 creates natural upgrade triggers.
          5,000 free credits at signup (card required). White-glove adds a dedicated human operator on Scale tier.
        </motion.p>
