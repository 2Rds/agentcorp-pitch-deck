...
const stack = [
  ...
  { layer: 'Agent Layer', items: ['9 Agents × @waas/runtime', 'Scoped Tools + Memory', '100+ Tools · 162 Plugins'], color: 'var(--gold)' },
  ...
  { layer: 'Infrastructure', items: ['DigitalOcean App Platform', 'Supabase + Redis 8.6.1', 'Stripe Billing + Webhooks'], color: 'var(--text-2)' },
];
    ...
    <div className="slide-shell">
      ...
      <motion.div className="slide-inner" variants={c} initial="hidden" animate="visible">
        ...
        <motion.h2 variants={i} className="t-title c-wgite" style={{ maxWidth: 860, marginBottom: '0.5rem' }}>
          Six layers. All live.{' '}
          <span className="c-cyan">Nothing on the roadmap.</span>
        </motion.h2>
