    ...
    <div className="slide-shell">
      ...
      <motion.div className="slide-inner" variants={c} initial="hidden" animate="visible">
        ...
        <motion.div variants={i} style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '0.75rem' }}>
          ...
          <div style={{ padding: '1rem 1.25rem', background: 'var(--surface)', border: '1px solid var(--border-hi)', borderRadius: 'var(--radius-lg)' }}>
            <div style={{ fontFamily: 'var(--font-mono)', fontSize: '0.6rem', letterSpacing: '0.08em', color: 'var(--gold)', marginBottom: '0.5rem' }}>OUTBOUND PIPELINE + 60-DAY PLAN</div>
            <div style={{ fontFamily: 'var(--font-body)', fontSize: '0.78rem', color: 'var(--text-2)', lineHeight: 1.5 }}>
              232 companies + 34 named contacts enriched across target ICP. Operation Six Hats campaign
              active — cold outbound → demo → close, 20% demo-close target. 10 paying customers in
              60 days; 50 by month 6, NRR tracking above 120%.
            </div>
          </div>
        </motion.div>
      </motion.div>
